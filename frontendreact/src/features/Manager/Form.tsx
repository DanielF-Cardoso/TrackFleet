...
const ManagerForm: React.FC<ManagerFormProps> = ({ formData, handleInputChange, handleSubmit }) => {
  ...
  useEffect(() => {
    try {
      ...
      managerSchema.parse(dataToValidate);
      setIsFormValid(true);
      setErrors({});
    } catch (error: any) {
        ...
        <div className="row g-3 mt-1">
          ...
          <div className="col-md-4">
            ...
            <input
              ...
              minLength={6}
            />
            {shouldShowError('password') && <div className="error-feedback">{errors.password}</div>}
          </div>
          <div className="col-md-4">
