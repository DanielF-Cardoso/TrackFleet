...
import { managerSchema } from '@/utils/validation';
import { Picker } from '@react-native-picker/picker';
import { maskCep, maskPhone } from '@/utils/helpers';


type CreateManagerFormData = z.infer<typeof managerSchema>;
interface CreateManagerModalProps {
    visible: boolean;
    onClose: () => void;
    onSave: (data: CreateManagerFormData) => void;
}

export default function CreateManagerModal({ visible, onClose, onSave }: CreateManagerModalProps) {
    ...
    const onSubmit: SubmitHandler<CreateManagerFormData> = async (data) => {
        setIsLoading(true);
        try {
            await onSave(data);
            reset();
            ...
            let apiMessage = 'Não foi possível cadastrar o gestor.';
            ...
            <View style={styles.modalOverlay}>
                <View style={styles.modalContent}>
                    <View style={styles.modalHeader}>
                        <Text style={styles.modalTitle}>Cadastro de Gestor</Text>
                            ...
                            <Controller
                                ...
                                render={({ field: { onChange, value } }) => (
                                    <Input
                                        ...
                                        leftIcon={<Feather name="lock" size={20} color="#6B7280" />}
                                        secureTextEntry
                                    />
                                )}
                            />
